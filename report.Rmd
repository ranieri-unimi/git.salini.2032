...
However also the number of possible playable Pokemon is quite high. Let's apply K meansto delineate groups of interchangeable Pokémon.
...
The accuracy of tree predictions is evaluated by computing the MSE. A side dataset obtained by surveying some players is used as test set.
...
However performance are globally poor, maybe due to lack of enough data that would help to build a more consistent model.
